    ...
    stages{
        stage('Build with Maven') {
            steps{
                ...
                checkout scmGit(branches: [[name: '*/master']], extensions: [], userRemoteConfigs: [[credentialsId: 'Git_Cred', url: 'https://github.com/Bestedeki/Jenkins-Docker-K8s-Spring-boot-mongo.git']])
